...
export default function Footer() {
  return (
    <footer className="bg-blue-700 text-white py-8 px-4 mt-12">
      <div className="container mx-auto grid md:grid-cols-3 gap-8 text-center md:text-left">
        {/* Branding */}
        <div>
          <h2 className="text-2xl font-bold mb-2">TheCrate</h2>
          <p className="text-sm">
            Your trusted platform for tech services and solutions.
          </p>
        </div>
      ...
      <div className="text-center text-sm mt-8 border-t border-blue-500 pt-4">
        © {new Date().getFullYear()} TheCrate. All rights reserved.
      </div>
    </footer>
  );
}
